...
def propagate(w, b, X, Y):
    ...
    Y -- true "label" vector (containning 0 if non-cat, 1 if cat) of size (1, number of examples)

    Returns:
    cost -- negative log-likelihood cost for logistic regreesion
